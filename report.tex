...
\titlespacing{\chapter}{0cm}{20pt}{20pt}
\titlespacing{\section}{0cm}{20pt}{0.5cm}
\titlespacing{\subsection}{0cm}{20pt}{0.5cm}
\titlespacing{\subsubsection}{0cm}{20pt}{0.5cm}
...
\centering
\includegraphics[width=5cm]{login.jpg}
\caption{\centering \tiny Login screen}
\end{subfigure}
\begin{subfigure}[b]{.3\textwidth}
\centering
\includegraphics[width=5cm]{google_signin.jpg}
\caption{\centering \tiny Forgot password screen }
\end{subfigure}
\begin{subfigure}[b]{.3\textwidth}
\centering
\includegraphics[width=5cm]{forgot_password.jpg}
\caption{\centering \tiny Signup screen }
\end{subfigure}
\end{figure}
...
\begin{subfigure}[h!]{.3\textwidth}
\centering
\includegraphics[width=5cm]{deliverer_view.jpg}
\caption{\centering \tiny Order detail view}
\end{subfigure}
\begin{subfigure}[h!]{.3\textwidth}
\centering
\includegraphics[width=5cm]{deliverer_drawer.jpg}
\caption{\centering \tiny Order detail view}
\end{subfigure}
\end{figure}
